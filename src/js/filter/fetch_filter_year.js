...
export function filterGlobalYear(year, page) {
    const REQUEST_ADRESS = `${BASE_URL}&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}&year=2000&with_watch_monetization_types=flatrate`
