...
export function filterGlobalYear(year, page) {
    const REQUEST_ADRESS = `${BASE_URL}&include_adult=false&include_video=false&page=${page}&primary_release_year=2000&with_genres=Action&with_watch_monetization_types=flatrate`
